...
const TOOLS = [
  { href: "/research/injury-risk-ai", title: "Injury-risk AI prototype", text: "Combine live MediaPipe biomechanics with history, readiness, training exposure, and explainable multimodal research-model inference." },
